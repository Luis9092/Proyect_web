...
<html>
    ...
    <body>
        <button type="button" class="btn btn-warning text-white"  data-toggle="modal" data-target="#modal_cliente" onclick="Limpiar2()">
            Formulario
        </button>
                            ...
                            <form action="src_cliente" class="formulario" method="post" id="formulario" >
                                ...
                                <div class="formulario__grupo" id="grupo__txt_nombre">
                                    ...
                                    <div class="formulario__grupo-input">
                                        ...
                                        <input type="text" class="formulario__input  " name="txt_nombre" id="txt_nombre"  pattern="[A-Z]{1}[a-zA-ZÀ-ÿ\s]{4,40}([ ][A-Z]{1}[a-zA-ZÀ-ÿ\s]{4,40})?"  placeholder="nombres" required>
                                ...
                                <div class="formulario__grupo" id="grupo__txt_apellido">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name="txt_apellido" id="txt_apellido" pattern="[A-Z]{1}[a-zA-ZÀ-ÿ\s]{4,40}[ ][A-Z]{1}[a-zA-ZÀ-ÿ\s]{4,40}" placeholder="Apellido" required>
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                                ...
                                <div class="formulario__grupo" id="grupo__txt_nit">
                                    ...
                                    <p class="formulario__input-error">Nit Valido #####-#</p>
                                </div>
                                ...
                                <div class="formulario__grupo" id="grupo__txt_telefono">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name="txt_telefono" id="txt_telefono" pattern="[+]{1}[0-9]{1,4}[ ][0-9]{7,14}" placeholder="4491234567" required>
                                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                    </div>
                                ...
                                <button type="button"  class="btn btn-warning text-white" onclick="recargar()"   data-dismiss="modal">Close</button>
                            </div>
